            ...
            <div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24">
                ...
                <form method="POST" action="/job-seekers/{{ $jobseekerlisting['id'] }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <button
                            class="add-item w-full px-4 py-2 mt-4 text-white bg-blue-500 rounded-md hover:bg-blue-600"
                                ...
                                @foreach ($skills_array as $index => $skill)
                                    ...
                                    <div class="mt-3 ml-2">
                                        <div class="flex justify-center">
                                            ...
                                            @if ($index > 0)
                                                <button type="button"
                                                    class="remove-skill ml-1  text-red-500 self-center">X</button>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <button type="button" id="add-skill"
                        class="w-full px-4 py-2 mt-4 bg-blue-500  hover:bg-blue-600 text-white font-medium rounded-md  ">Add
                        skill</button>
