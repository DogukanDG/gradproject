...
<div class="p-6 ml-3 mr-6 mt-5 border border-gray-200 rounded-lg shadow-lg bg-gray-100">
    ...
    <div class="mt-3">
        ...
        <div class="relative">
            ...
            <a href="/listings/{{ $listing['id'] }}"
                class="inline-flex items-center relative bottom-0 left-0 px-4 py-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
